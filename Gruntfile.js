        ...
        uglify: {
            my_target: {
                files: {
                    ...
                    '<%= yeoman.dist %>/bower_components/jquery-ui/jquery-ui.js': '<%= yeoman.app %>/bower_components/jquery-ui/jquery-ui.js',
                    '<%= yeoman.dist %>/bower_components/jQuery-switchButton/jquery.switchButton.js': '<%= yeoman.app %>/bower_components/jQuery-switchButton/jquery.switchButton.js',
                    ...
                    '<%= yeoman.dist %>/scripts/views/add-more-view.js': '<%= yeoman.app %>/scripts/views/add-more-view.js',
